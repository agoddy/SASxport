...
class Reader(object):
    ...
    def _read_header(self):
        ...
        try:
            match_(b'HEADER RECORD*******LIBRARY LIBV8 RECORD!!!!!!!', prefix)
    ...
    def _read_member_header(self):
        ...
        match_(b'HEADER RECORD*******MEMBV8  HEADER RECORD!!!!!!!', prefix)
        ...
        match_(b'HEADER RECORD*******DSCPTV8 HEADER RECORD!!!!!!!', prefix)
    ...
    def _read_namestr_header(self):
        ...
        match_(b'HEADER RECORD*******NAMSTV8 HEADER RECORD!!!!!!!', prefix)
    ...
    def _read_observations_header(self):
        ...
        match_(b'HEADER RECORD*******OBSV8     HEADER RECORD!!!!!!!', prefix)
...
def from_columns(mapping, fp):
    ...
    sas_version = b'9.4    ' # the version in the SAS XPT specification I read
    os_version = platform.system().encode('ISO-8859-1')[:8].ljust(8)
    created = format_date(datetime.now())

    # 1st real header record
    fp.write(b'HEADER RECORD*******LIBV8 HEADER RECORD!!!!!!!'
    ...
    fp.write(b'HEADER RECORD*******MEMBV8  HEADER RECORD!!!!!!!'
             b'000000000000000001600000000140  '
             b'HEADER RECORD*******DSCPTV8 HEADER RECORD!!!!!!!'
             b'000000000000000000000000000000  ')
    ...
    fp.write(b'HEADER RECORD*******NAMSTV8 HEADER RECORD!!!!!!!'
             b'000000'
    ...
    # Observation header
    fp.write(b'HEADER RECORD*******OBSV8     HEADER RECORD!!!!!!!'
             b'000000000000000000000000000000  ')
...
if __name__ == '__main__':
    result = pyreadr.read_r('../tests/sas_df.rds')
    sas_df =  pd.DataFrame(result[None])
    sas_df.head()
    with open('./test.xpt', 'wb') as f:from_columns(sas_df, f)
    print('wait')
